...
class DetilesSuccessStories extends StatefulWidget {
  String mainImage;
  String title;
  String date;
  String fulldetiles;
  ...
  DetilesSuccessStories(this.mainImage, this.title, this.date,this.fulldetiles);

  @override
  _DetilesSuccessStoriesState createState() => _DetilesSuccessStoriesState();
}

class _DetilesSuccessStoriesState extends State<DetilesSuccessStories> {
  @override
